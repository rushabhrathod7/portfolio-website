...
const signals = [
  {
    date: "2025.06.10",
    title: "Next.js 16",
    note: "Latest features including enhanced caching, React 19.2 support, and performance improvements.",
  },
  {
    date: "2025.05.28",
    title: "TypeScript 5.6",
    note: "Enhanced type inference and improved developer experience for full stack applications.",
  },
  {
    date: "2025.05.15",
    title: "Supabase Edge",
    note: "Real-time database capabilities with Row Level Security and serverless functions.",
  },
  {
    date: "2025.04.30",
    title: "Vercel AI SDK",
    note: "Build AI-powered applications with streaming, function calling, and tool support.",
  },
  {
    date: "2025.04.12",
    title: "Tailwind v4",
    note: "Redesigned configuration system with better performance and modern CSS features.",
  },
]
