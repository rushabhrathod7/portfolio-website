...
const experiments = [
  {
    title: "Next.js + React",
    medium: "Frontend Framework",
    description: "Server and client components, app router, streaming, and full stack capabilities.",
  ...
  },
  {
    ...
    description: "Build intelligent features with streaming, RAG, and agent capabilities.",
    span: "col-span-2 row-span-1",
  },
  {
    title: "shadcn/ui",
    medium: "Component Library",
    description: "Accessible, customizable components built with Radix UI.",
    span: "col-span-1 row-span-1",
  },
]
  ...
  return (
    <section ref={sectionRef} id="work" className="relative py-32 pl-6 md:pl-28 pr-6 md:pr-12">
      ...
      <div ref={headerRef} className="mb-16 flex items-end justify-between">
        <div>
          <span className="font-mono text-[10px] uppercase tracking-[0.3em] text-accent">02 / Technologies</span>
          <h2 className="mt-4 font-[var(--font-bebas)] text-5xl md:text-7xl tracking-tight">TECH STACK</h2>
        </div>
        <p className="hidden md:block max-w-xs font-mono text-xs text-muted-foreground text-right leading-relaxed">
          Modern technologies for building scalable, performant full stack applications.
        </p>
      </div>
