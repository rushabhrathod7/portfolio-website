...
export function TechStackSection() {
  ...
  return (
    ...
    >
      ...
      >
        {siteConfig.techStack.map((category, index) => (
          <article
            key={index}
            className={cn(
          ...
          >
            <div className="relative bg-card border border-border/50 md:border-t md:border-l md:border-r-0 md:border-b-0 p-8">
              ...
              <h3 className="font-[var(--font-bebas)] text-3xl tracking-tight mb-6 group-hover:text-accent transition-colors duration-300">
                {category.category}
              </h3>
