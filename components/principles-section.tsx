  ...
  const principles = [
    {
      ...
      description:
        "End-to-end type safety from database schemas to UI components. Catch errors at compile time, not runtime.",
      align: "left",
    },
    {
      number: "02",
      ...
      description: "Optimize for performance with server components. Send less JavaScript, render on demand.",
      align: "right",
    },
    {
      number: "03",
      ...
      description: "Design with Row Level Security and proper authorization. Protect data at the database level.",
      align: "left",
    },
    {
      number: "04",
      titleParts: [
        { text: "PROGRESSIVE ", highlight: false },
        { text: "ENHANCEMENT", highlight: true },
      ],
      description: "Build resilient applications that work without JavaScript and enhance with interactivity.",
      align: "right",
    },
  ]
  ...
  return (
    <section ref={sectionRef} id="principles" className="relative py-32 pl-6 md:pl-28 pr-6 md:pr-12">
      ...
      <div ref={headerRef} className="mb-24">
        ...
        <h2 className="mt-4 font-[var(--font-bebas)] text-5xl md:text-7xl tracking-tight">BEST PRACTICES</h2>
      </div>
